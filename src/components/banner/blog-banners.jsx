...
const BlogBanners = ({ left = false, right = false, top = false, bottom = false, data = initialData }) => {
    const leftBlog = () => {
        return (
            <div className="row">
                <div className="col-xl-6 blog-items img" style={{ backgroundImage: `url(${img})` }}></div>
    ...
    const rightBlog = () => {
        return (
            <div className="row">
                <div className="col-xl-6 order-xl-2 blog-items img" style={{ backgroundImage: `url(${img})` }}></div>
