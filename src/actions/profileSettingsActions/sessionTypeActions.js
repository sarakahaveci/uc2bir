...
export const deleteAddressList =
  (id, successCallback, errorCallback) => async (dispatch, getState) => {
...
export const getGymList =
  (date, hour, branch) => async (dispatch, getState) => {
...
export const getFilteredGymList =
  (date, hour, branch) => async (dispatch, getState) => {
...
export const searchGymForPt =
  (title = false, page, location, branch) =>
  async (dispatch) => {
...
export const searchGymWithDetail =
  (title = false, page = 0, location = false, branch = false) =>
  async (dispatch) => {
