                ...
                <div className="slider-item-content">
                    <div className="img-item">
                        <div className="img" style={{ backgroundImage: `url(${val.node.frontmatter.image.childImageSharp.fluid.src})` }}>
                            ...
                            <div className="clock-times">
                                <span className="icon"><AwesomeIcon.Clock/></span>
                                <span className="text">{val.node.frontmatter.date}</span>
                            </div>
                        </div>
                        <div className="info"><Title lineDisable fontWeight="ligher">{val.node.frontmatter.category}</Title></div>
                    </div>
                    <div className="text-item">
                        ...
                        <div className="row info">
                            <div className="col">
                                <ul>
                                    <li style={{fontSize: "10pt"}}>{val.node.frontmatter.content}</li>
                                    <li style={{fontSize: "8pt", marginTop: 5}}><AwesomeIcon.Map/> {val.node.frontmatter.location}</li>
                                </ul>
                            </div>
                            <div style={{position: 'relative'}} className="col-auto">
                                <span style={{fontSize: "9pt", fontWeight: "normal", color: "#00b2a9", position: 'absolute', top: "-47px", left: "inherit", right: "0"}}>{val.node.frontmatter.seater} Kişilik</span>
                                
                                <span>{val.node.frontmatter.price} <AwesomeIcon.Tl /></span>
                                <br/>
