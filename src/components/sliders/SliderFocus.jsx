                    ...
                    <div className="col right">
                        <div className="item-right">
                            ...
                            >
                                ...
                                <div className="slider-item">
                                    <div className="img item-two" style={{ backgroundImage: `url(${hazal})` }}></div>
                                </div>
                                <div className="slider-item">
                                    <div className="img item-three" style={{ backgroundImage: `url(${efe})` }}></div>
                                </div>
                                <div className="slider-item">
                                    <div className="img item-three" style={{ backgroundImage: `url(${hazal})` }}></div>
                                </div>
                            </SlickSlider>
                        </div>
                    </div>
