...
const sliderItems = [
  { title: "Başarmak İçİn sen de hemen başla!", desc: "Spor için tutku, özgürlük, motivasyon, enerji; Forma Girmek için heves, istikrar, profesyonel destek; Grup Motivasyonu için ortak   hedefler, beraberlikten gelen itici güç! Unutma hedeflerini ancak  başlayanlar başarabilir.", src: img0 },
  ...
  { title: "Lorem Ipsum 2", desc: "At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est ", src: img2 },
  { title: "Lorem Ipsum 3", desc: "On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of wil", src: img3 }
];

const TopPromotion = ({ className, background, children }) => {
  const [title, setTitle] = useState(sliderItems[0]?.title);
  const [desc, setDesc] = useState(sliderItems[0]?.desc);
