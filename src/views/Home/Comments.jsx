          ...
          <SlickSlider {...settings}>
            ...
            <div className="slider-item">
              ...
              <div className="text">
                ...
                karşılaşma fırsatı buldum. Spor salonlarında, çeşitli alanlarda,
                park gibi halka açık yerlerde eğitimlerimi verebiliyorum.
                Pandemi sürecinde ise danışanlarıma özel dersler verebildim.
                Bana bu fırsatı sunduğunuz için teşekkürler Üç2Bir!
              </div>
              <div className="foot">
            ...
            <div className="slider-item">
              ...
              <div className="text">
                ...
                kilo, stres, düzensiz beslenme gibi olumsuz şartlardan çıkmasına
                yardımcı oldum. Bütün bunları yapmak ise çok kolay oldu. Üç2Bir
                ile birlikte sağlıkla kalın!
              </div>
              <div className="foot">
