        ...
        <>{top && 
            <div className="slider-item">
                <div className="img" style={{ backgroundImage:`url(${val.node.frontmatter.image.childImageSharp.fluid.src})`}}>
                    <ul className="points">
                        <li className={`${val.node.frontmatter.stars > 0 ? "active" : ""}`}><AwesomeIcon.StarSolid /></li>
                        <li className={`${val.node.frontmatter.stars > 1 ? "active" : ""}`}><AwesomeIcon.StarSolid /></li>
                        <li className={`${val.node.frontmatter.stars > 2 ? "active" : ""}`}><AwesomeIcon.StarSolid /></li>
                        <li className={`${val.node.frontmatter.stars > 3 ? "active" : ""}`}><AwesomeIcon.StarSolid /></li>
                        <li className={`${val.node.frontmatter.stars > 4 ? "active" : ""}`}><AwesomeIcon.StarSolid /></li>
                    </ul>
                </div>
            </div>
        }{bottom &&
